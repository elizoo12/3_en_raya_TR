...
def JugarPVP():
  ...
  while el_juego_funciona:
    ...
    #JugadaPVP de cada jugador
    JugadaPVP(Jugador_del_Turno)
...
def Cambiar_JugadorPVP():
  # traemos las variables globales necesarias
  global Jugador_del_Turno
  #si el jugador es X pasamos a O
  if Jugador_del_Turno == "X":
    Jugador_del_Turno = "O"
  #  si el jugador es O pasamos a X
  elif Jugador_del_Turno == "O":
    Jugador_del_Turno = "X"


# ------------ Ejecutamos todo el codigo -------------
# Tan solo jugamos, si nos fijamos hemos ido desplegando funciones unas dentro de otras y hemos terminado con una sola que es la ejecucion del juego.
